...
g.fillOval(xcenter - 90, ycenter - 95, 180, 180);
g.setColor(Color.blue);
g.drawString("abhishek" ,113,300);
g.setColor(Color.green);
g.drawString("9", xcenter - 70, ycenter +0);
g.drawString("3", xcenter + 60, ycenter + 0);
g.drawString("12", xcenter - 10, ycenter - 55);
g.drawString("6", xcenter - 10, ycenter + 80);
...
xsecond = (int) (Math.cos(second * 3.14f / 30 - 3.14f / 2) * 85 + xcenter);
ysecond = (int) (Math.sin(second * 3.14f / 30 - 3.14f / 2) * 85 + ycenter);
xminute = (int) (Math.cos(minute * 3.14f / 30 - 3.14f / 2) * 70 + xcenter);
yminute = (int) (Math.sin(minute * 3.14f / 30 - 3.14f / 2) * 70 + ycenter);
